...
function App() {
  ...
  return (
    ...
    <>
      <div className='flex h-screen justify-center items-center bg-white dark:bg-black flex-col'>
        <button
          className={`bg-green-600 rounded-xl p-4 ${theme === "dark" ? "text-white" : "black"}`}
